...
class SM_MarkerConfig
{
	...
	//     кути.
	//     Чому саме 400, а не «скільки не шкода»: стільки ж лишає від заливки завантажувач шаблонів
	//     (TPL_FILL_MAX_PTS), де ця межа виявилась візуально непомітною. Тримати живий ліміт вищим
	//     означало б платити за точки, які все одно зріжуться при збереженні в шаблон. А платимо ми
	//     дорого: тріангуляція O(n²), тож 1000 точок коштували вшестеро більше за 400 при тій самій
	//     картинці. Діє лише в режимі enhanced fill; звичайна заливка бере 250.
	int  m_iDrawMaxPointsPerFill = 400;
